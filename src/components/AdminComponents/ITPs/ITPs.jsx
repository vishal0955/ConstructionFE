...
//               >
//                 <option value="All Types">Group By</option>
//                 <option value="trade">
//                   Trade
//                 </option>
//                 <option value="zone">Zone</option>
//                 <option value="unitnumber">Unit number</option>
//                 <option value="projectstage">Project Stage</option>
//            </select>
//             </div>

//       {/*  if group by is selected then dynamically show this dropdown  */}
//       <div className="col-md-4">
    ...
    <div className="p-4">
      ...
      <div className="mt-4 shadow-sm p-3 bg-white rounded-3">
        ...
        <div className="flex justify-content-between align-items-center mb-3">
           ...
           {folders.map((folder) => (
              <div className="card mb-3" key={folder.id}>
                <div className="card-body d-flex align-items-center">
                  <div className="me-3">{folder.icon}</div>
